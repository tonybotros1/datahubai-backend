...
from ..collections import legislations_collection, payroll_elements_based_elements_collection, \
    employees_payrolls_collection


async def py_social_security_employer_ff(employee_id: ObjectId, main_payroll_element_id: ObjectId, legislation: ObjectId,
    ...
    try:
        ...
        ceiling = 0
        social_security_employer_percentage = 0
        ...
        for social_security_ceiling in social_security_ceilings:
            ...
            if (start_date <= period_end_date) and (end_date is None or end_date >= period_end_date):
                ...
                social_security_employer_percentage = social_security_ceiling.get("employer_percentage", 0)

        social_security_employer_percentage = social_security_employer_percentage / 100
